...
def generate_revision_details(description: str) -> dict:
    ...
    name = _run_ai( # Runs the AI prompt with the supporting prompt
        f'Give a short, descriptive, funny, witty, and Direct/Concise name for a revision or iteration of a 3D printing design. '
...
def generate_project_details(description: str) -> dict:
    ...
    name = _run_ai( # Runs the AI prompt with the supporting prompt
        f'Give a short, creative, funny, witty, and Direct/Concise name for a 3D printing project described as: "{desc}". '
