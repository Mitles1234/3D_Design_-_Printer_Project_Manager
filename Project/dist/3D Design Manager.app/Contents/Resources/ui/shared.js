...
function showToast(message, isError = false) {
    /**
    This function is used to show a toast message to the user. It takes in a message and an optional isError parameter 
    to indicate if the message is an error or not, which changes CSS styling to a red action colour.
    */
...
const COLOURS = [ // List of all of the Colours the user can choose from in the UI
  { hex: '#ef4444', name: 'Red' },
